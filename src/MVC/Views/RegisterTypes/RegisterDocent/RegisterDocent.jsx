...
function RegisterDocent() {
  ...
  useEffect(() => {
    fetch('http://192.168.199.215:40009/sexs')
  ...
  const handleRegistro = async () => {
    ...
    ) 
    {
      ...
      try {
        const response = await fetch('http://192.168.199.215:40009/users/insert', {
          method: 'POST',
