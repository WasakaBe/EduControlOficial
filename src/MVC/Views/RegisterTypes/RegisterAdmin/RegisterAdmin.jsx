...
function RegisterAdmin() {
  ...
  useEffect(() => {
    fetch('http://192.168.1.24:40009/sexs')
  ...
  const handleRegistro = async () => {
    ...
    ) 
    {
      ...
      try {
        const response = await fetch('http://192.168.1.24:40009/users/insert', {
          method: 'POST',
    ...
    <div>
      ...
      <p style={{ color: 'red' }}>
        La contraseña debe tener al menos 8 caracteres, incluyendo al menos una mayúscula, una minúscula, un número y un carácter especial.
            ...
            <input type='text' placeholder='Ingrese su numero de control' value={numeroControl}
