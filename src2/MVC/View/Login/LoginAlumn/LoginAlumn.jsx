        ...
        <div className='container-info-loginAlumn'>
          <div className='welcome-login'>
            ...
            <p className='login-text'>
              Nos emociona tenerte de regreso en nuestra plataforma educativa. Prepárate para sumergirte en un mundo de
              aprendizaje interactivo y descubrimiento continuo. Entra para explorar recursos actualizados, conectar con
              compañeros de clase y acceder a contenido educativo exclusivo.
            </p>
